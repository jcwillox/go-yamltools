...
// ParseBoolNode will parse a boolean node and return its value
// if the node is not a boolean node `ok` will be false.
// This is useful if you want to apply a different transform based
// on a boolean flag in the YAML.
